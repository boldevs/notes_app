<template>
  <div class="min-h-screen flex items-center justify-center px-4 bg-gray-100">
    <form
      ...
      class="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-md space-y-6"
    >
      <h2 class="text-2xl sm:text-3xl font-bold text-center text-gray-800">Login</h2>
      ...
      <el-input
        ...
        clearable
        :class="{ 'border border-red-500 rounded': usernameError }"
        class="w-full"
      />
      ...
      <el-input
        ...
        clearable
        :class="{ 'border border-red-500 rounded': passwordError }"
        class="w-full"
      >
        <template #suffix>
